...
var Myname = "Kent Beck";
var quote = `My name is  ${Myname} and I said  "I’m not a great programmer; I’m just a good programmer with great habits" `;
console.log(quote);
// question 5
...
var Famous_poet = `steve jobs`;
var Massage = `The poet ${Famous_poet} once said  
...
var Massage = `My favorite number is ${favoritenumber}`;
console.log(Massage);
// question 10 
...
var usernumbers = [0, 10, 20, 30, 40, 50, 60];
console.log(usernumbers[6]);
// question 11 
//Names: Store the names of a few of your friends in a array called names. Print each person’s name by accessing each element in the list, one at a time
[0, 1, 2, 3, 4, 5, 6];
let friendNames = ["zeeshan", "ali", " qasim", "ahad", "hamza", "hassan"];
...
[0, 1, 2, 3, 4];
var names = ["ayesha", "asif", "hamid", "raida",];
...
var transportationnNames = ["motorcycle", "car ", "aeroplane"];
...
var guestNames = ["maryam", " zainab", "eman", "kinza"];
let inviteguest1 = ` hey' ${guestNames[3]},"please come to a dinner"`;
console.log(inviteguest1);
let inviteguest2 = ` hey' ${guestNames[2]},"please come to a dinner"`;
console.log(inviteguest2);
let inviteguest3 = ` hey' ${guestNames[1]},"please come to a dinner"`;
...
let inviteguestA = ` hey' ${guestNames[3]},"please come to a dinner"`;
console.log(inviteguestA);
let inviteguestB = ` hey' ${guestNames[2]},"please come to a dinner"`;
console.log(inviteguestB);
// Add a print statement at the end of your program stating the name of the guest who can’t make it
var inviteguestC = `hey' ${guestNames[1]}"sorry can't make it to dinner"`;
console.log(inviteguestC);
// Modify your list, replacing the name of the guest who can’t make it with the name of the new person you are inviting
// replace the name of guest [1]
let personCannotMakeIt = "ayesha";
